...
class HtmlReporter:
    ...
    def report(self, morfs):
        ...
        if files_to_report:
            ...
            first_html = final_html = "produto1.html"
    ...
    def index_file(self, first_html, final_html):
        """Write the produto1.html file for this report."""
        self.make_directory()
        index_tmpl = Templite(read_data("produto1.html"), self.template_globals)
        ...
        index_file = os.path.join(self.directory, "produto1.html")
...
class IncrementalChecker:
    ...
    def index_info(self, fname):
        """Get the information for produto1.html for `fname`."""
        return self.files.get(fname, {}).get('index', {})

    def set_index_info(self, fname, info):
        """Set the information for produto1.html for `fname`."""
